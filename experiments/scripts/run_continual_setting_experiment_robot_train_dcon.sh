...
# TRANSE - THOR_U
STARTTIME=$(date +%s)
python experiments/continual_setting.py THOR_U -mt transe -nr 1 -hh 25 -op 0.1 -m 2.0 -clm offline -ln 1 -eo 0
...
python experiments/continual_setting.py THOR_U -mt transe -nr 1 -hh 25 -op 0.1 -m 2.0 -clm offline -ln 2 -eo 0
...
python experiments/continual_setting.py THOR_U -mt transe -nr 1 -hh 25 -op 0.1 -m 2.0 -clm offline -ln 3 -eo 0
...
python experiments/continual_setting.py THOR_U -mt transe -nr 1 -hh 25 -op 0.1 -m 2.0 -clm offline -ln 4 -eo 0
...
python experiments/continual_setting.py THOR_U -mt transe -nr 1 -hh 25 -op 0.1 -m 2.0 -clm offline -ln 5 -eo 0
...
# ANALOGY - THOR_U
STARTTIME=$(date +%s)
python experiments/continual_setting.py THOR_U -mt analogy -nr 50 -hh 100 -op 0.1 -clm offline -ln 1 -eo 0
...
python experiments/continual_setting.py THOR_U -mt analogy -nr 50 -hh 100 -op 0.1 -clm offline -ln 2 -eo 0
...
python experiments/continual_setting.py THOR_U -mt analogy -nr 50 -hh 100 -op 0.1 -clm offline -ln 3 -eo 0
...
python experiments/continual_setting.py THOR_U -mt analogy -nr 50 -hh 100 -op 0.1 -clm offline -ln 4 -eo 0
...
python experiments/continual_setting.py THOR_U -mt analogy -nr 50 -hh 100 -op 0.1 -clm offline -ln 5 -eo 0
