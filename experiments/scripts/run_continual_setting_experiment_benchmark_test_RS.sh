...
python experiments/continual_setting.py WN18RR -mt transe -nr 25 -hh 100 -m 8.0 -op 0.1 -clm L2 -rs 10.0 -ln 1 -sm TEST
...
python experiments/continual_setting.py WN18RR -mt transe -nr 25 -hh 100 -m 8.0 -op 0.1 -clm L2 -rs 10.0 -ln 2 -sm TEST
...
python experiments/continual_setting.py WN18RR -mt transe -nr 25 -hh 100 -m 8.0 -op 0.1 -clm L2 -rs 10.0 -ln 3 -sm TEST
...
python experiments/continual_setting.py WN18RR -mt transe -nr 25 -hh 100 -m 8.0 -op 0.1 -clm L2 -rs 10.0 -ln 4 -sm TEST
...
python experiments/continual_setting.py WN18RR -mt transe -nr 25 -hh 100 -m 8.0 -op 0.1 -clm L2 -rs 10.0 -ln 5 -sm TEST
...
python experiments/continual_setting.py WN18RR -mt analogy -nr 1 -hh 200 -op 0.01 -clm L2 -rs 0.001 -ln 1 -sm TEST
python experiments/continual_setting.py WN18RR -mt analogy -nr 1 -hh 200 -op 0.01 -clm SI -rs 0.01 -ln 1 -sm TEST
...
python experiments/continual_setting.py WN18RR -mt analogy -nr 1 -hh 200 -op 0.01 -clm L2 -rs 0.001 -ln 2 -sm TEST
python experiments/continual_setting.py WN18RR -mt analogy -nr 1 -hh 200 -op 0.01 -clm SI -rs 0.01 -ln 2 -sm TEST
...
python experiments/continual_setting.py WN18RR -mt analogy -nr 1 -hh 200 -op 0.01 -clm L2 -rs 0.001 -ln 3 -sm TEST
python experiments/continual_setting.py WN18RR -mt analogy -nr 1 -hh 200 -op 0.01 -clm SI -rs 0.01 -ln 3 -sm TEST
...
python experiments/continual_setting.py WN18RR -mt analogy -nr 1 -hh 200 -op 0.01 -clm L2 -rs 0.001 -ln 4 -sm TEST
python experiments/continual_setting.py WN18RR -mt analogy -nr 1 -hh 200 -op 0.01 -clm SI -rs 0.01 -ln 4 -sm TEST
...
python experiments/continual_setting.py WN18RR -mt analogy -nr 1 -hh 200 -op 0.01 -clm L2 -rs 0.001 -ln 5 -sm TEST
python experiments/continual_setting.py WN18RR -mt analogy -nr 1 -hh 200 -op 0.01 -clm SI -rs 0.01 -ln 5 -sm TEST
...
python experiments/continual_setting.py FB15K237 -mt analogy -nr 25 -hh 200 -op 0.01 -clm L2 -rs 0.1 -ln 1 -sm TEST
python experiments/continual_setting.py FB15K237 -mt analogy -nr 25 -hh 200 -op 0.01 -clm SI -rs 0.1 -ln 1 -sm TEST
...
python experiments/continual_setting.py FB15K237 -mt analogy -nr 25 -hh 200 -op 0.01 -clm L2 -rs 0.1 -ln 2 -sm TEST
python experiments/continual_setting.py FB15K237 -mt analogy -nr 25 -hh 200 -op 0.01 -clm SI -rs 0.1 -ln 2 -sm TEST
...
python experiments/continual_setting.py FB15K237 -mt analogy -nr 25 -hh 200 -op 0.01 -clm L2 -rs 0.1 -ln 3 -sm TEST
python experiments/continual_setting.py FB15K237 -mt analogy -nr 25 -hh 200 -op 0.01 -clm SI -rs 0.1 -ln 3 -sm TEST
...
python experiments/continual_setting.py FB15K237 -mt analogy -nr 25 -hh 200 -op 0.01 -clm L2 -rs 0.1 -ln 4 -sm TEST
python experiments/continual_setting.py FB15K237 -mt analogy -nr 25 -hh 200 -op 0.01 -clm SI -rs 0.1 -ln 4 -sm TEST
...
python experiments/continual_setting.py FB15K237 -mt analogy -nr 25 -hh 200 -op 0.01 -clm L2 -rs 0.1 -ln 5 -sm TEST
python experiments/continual_setting.py FB15K237 -mt analogy -nr 25 -hh 200 -op 0.01 -clm SI -rs 0.1 -ln 5 -sm TEST
